...
const Hero = () => {
  return (
    <section
      ...
      <div className="w-[1300px] flex items-center justify-center before:absolute before:w-full before:h-full before:bg-cover before:bg-[url('src/assets/Background.webp')] before:brightness-50">
        <div className="w-[500px] flex flex-col gap-4 z-10 text-zinc-50">
          ...
          <Button title="Fazer pedido " link="#contact" classGeral="w-52" icon="fa-solid fa-arrow-right" />
        </div>
